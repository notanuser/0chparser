...
public class PostContainer {
	 ...
	 * @param attachment путь к прикладываемому файлу.
	 * @param poster имя отправителя
	 * @param subject тема сообщения
	 * @param text текст сообщения
	 * @param sage мудрец идет во все поля.
	 */
	public PostContainer(String attachment, String poster, String subject, String text,
			boolean sage) {
		super();
	 ...
	 * @param text текст сообщения
	 */
	public PostContainer(String id, String attachment, String thumbnail, String poster,
			boolean saged, String date, String subject, String trip, String text) {
	 ...
	 * @return <code>true</code> - если была добавлена сажа и <code>false</code> - если нет.
	 */
