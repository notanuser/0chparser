...
public final class ThreadEntity extends PostEntity {
	 ...
	 * @param images
	 *            количество вложений в треде
	 */
	public ThreadEntity(String id, String attachment, String thumbnail,
			String poster, boolean saged, String date, String subject,
			String trip, String text, int posts, int images) {
		super(id, attachment, thumbnail, poster, saged, date, subject, trip,
				text);
		this.images = images;
		this.posts = posts;
	}
